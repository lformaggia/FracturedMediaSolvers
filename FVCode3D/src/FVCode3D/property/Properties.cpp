...
void PropertiesMap::setPropertiesOnMatrix(const Mesh3D & mesh, const Real porosity, const PermPtr_Type & permeability)
{
    std::set<UInt> zones;
...
void PropertiesMap::setPropertiesOnFractures(const Mesh3D & mesh, const Real aperture, const Real porosity, const PermPtr_Type & permeability)
{
    std::set<UInt> zones;
