...
namespace Geometry
{
  ...
  Segment CPcell::getEdge (const UInt& i) const
  {
    ...
    {
      case 1:
        edge = Segment (this->getVertex (1), this->getVertex (2) );
        break;
      case 2:
        edge = Segment (this->getVertex (2), this->getVertex (4) );
        break;
      case 3:
        edge = Segment (this->getVertex (4), this->getVertex (3) );
        break;
      case 4:
        edge = Segment (this->getVertex (3), this->getVertex (1) );
        break;
      case 5:
        edge = Segment (this->getVertex (1), this->getVertex (5) );
        break;
      case 6:
        edge = Segment (this->getVertex (2), this->getVertex (6) );
        break;
      case 7:
        edge = Segment (this->getVertex (4), this->getVertex (8) );
        break;
      case 8:
        edge = Segment (this->getVertex (3), this->getVertex (7) );
        break;
      case 9:
        edge = Segment (this->getVertex (5), this->getVertex (6) );
        break;
      case 10:
        edge = Segment (this->getVertex (6), this->getVertex (8) );
        break;
      case 11:
        edge = Segment (this->getVertex (8), this->getVertex (7) );
        break;
      case 12:
        edge = Segment (this->getVertex (7), this->getVertex (5) );
        break;
    }
    return edge;
  }
