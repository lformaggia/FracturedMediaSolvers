...
namespace Geometry
{
  ...
  bool Fracture::exportFracture2 (std::ofstream& myfile, gmm::size_type i)
  {
    ...
    if (!isAreaOK() )
    {
      myfile << "ATTENZIONE: errore aree superiore al 2%" << std::endl;
    }
    myfile << "Ne  " << M_Ne << std::endl;
