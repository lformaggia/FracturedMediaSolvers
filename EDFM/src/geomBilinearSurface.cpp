...
namespace Geometry
{
  ...
  std::vector<Real> BilinearSurface::inv_param (const Point3D& p) const
  {
    std::vector<Real> uv (2);
    this->projection (p, uv);
    return uv;
  }

  Point3D BilinearSurface::projection (const Point3D& s, std::vector<Real>& uv, const Real& toll,
                                       const UInt& maxIter) const
  {
    //    std::cout << "NEWTON: " << std::endl;
    //    std::cout << " ------------------------------ " << std::endl;
    ...
    while ( normRes > toll && it < maxIter)
    {
      // build Metric at point
      Point3D ru = (1 - x[1]) * (M_pB - M_pA) + x[1] * (M_pC - M_pD);
      Point3D rv = (1 - x[0]) * (M_pD - M_pA) + x[0] * (M_pC - M_pB);
  ...
  bool BilinearSurface::isIntersectedBy (BilinearSurface altra, std::vector<Point3D>& punti) const
  {
    ...
    if (uv1[0] >= 0 && uv1[0] <= 1 && uv1[1] >= 0 && uv1[1] <= 1 && uv1[2] >= 0 && s1.isIn (this->param (uv1[0], uv1[1]) ) )
    {
      cont += 1;
    ...
    if (uv2[0] >= 0 && uv2[0] <= 1 && uv2[1] >= 0 && uv2[1] <= 1 && uv2[2] >= 0 && s2.isIn (this->param (uv2[0], uv2[1]) ) )
    {
      cont += 1;
    ...
    if (uv3[0] >= 0 && uv3[0] <= 1 && uv3[1] >= 0 && uv3[1] <= 1 && uv3[2] >= 0 && s3.isIn (this->param (uv3[0], uv3[1]) ) )
    {
      cont += 1;
    ...
    if (uv4[0] >= 0 && uv4[0] <= 1 && uv4[1] >= 0 && uv4[1] <= 1 && uv4[2] >= 0 && s4.isIn (this->param (uv4[0], uv4[1]) ) )
    {
      cont += 1;
    ...
    if (uv5[0] >= 0 && uv5[0] <= 1 && uv5[1] >= 0 && uv5[1] <= 1 && uv5[2] >= 0 && s5.isIn (this->param (uv5[0], uv5[1]) ) )
    {
      cont += 1;
    ...
    if (uv6[0] >= 0 && uv6[0] <= 1 && uv6[1] >= 0 && uv6[1] <= 1 && uv6[2] >= 0 && s6.isIn (this->param (uv6[0], uv6[1]) ) )
    {
      cont += 1;
  ...
  bool BilinearSurface::isEdgeIntersectedBy (gmm::size_type quale, Segment S, Point3D& risultato) const
  {
    ...
    if (quale == 1)
    {
      if (L1.intersectTheSegment (S, risultato) )
      {
        return true;
      }
    }
    if (quale == 2)
    {
      if (L2.intersectTheSegment (S, risultato) )
      {
        return true;
      }
    }
    if (quale == 3)
    {
      if (L3.intersectTheSegment (S, risultato) )
      {
        return true;
      }
    }
    if (quale == 4)
    {
      if (L4.intersectTheSegment (S, risultato) )
      {
        return true;
      }
    }
